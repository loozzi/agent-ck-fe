...
import type { Category, CreateCategoryPayload, CreateLessonPayload, Lesson, UpdateLessonPayload } from '@/types/lesson.type'
...
const LessonManagement = () => {
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      await dispatch(updateLessonCategory({ 
  ...
  const filteredLessons = selectedCategory && selectedCategory !== 'all'
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>
                    Quản lý tất cả bài học trong hệ thống
                  </CardDescription>
                </div>
                    ...
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        {editingLesson 
                          ...
                          : 'Tạo bài học mới trong hệ thống'
                        }
                      </DialogDescription>
                    </DialogHeader>
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>
                    Quản lý danh mục phân loại bài học
                  </CardDescription>
                </div>
        ...
        <Dialog open={!!viewingLesson} onOpenChange={() => setViewingLesson(null)}>
          <DialogContent className="sm:max-w-[700px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Danh mục: {getCategoryName(viewingLesson.category_id)} | 
                Trạng thái: {viewingLesson.is_active ? 'Kích hoạt' : 'Tạm dừng'}
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
